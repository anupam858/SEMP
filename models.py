...
class Customercollection(models.Model):
      c_name= models.CharField(max_length=120,blank=True)
      c_email= models.EmailField(max_length=50, blank=True, unique= True)
      c_phone= models.CharField(max_length=12, blank=True)
      c_pswd= models.CharField(max_length=12, blank=True)
